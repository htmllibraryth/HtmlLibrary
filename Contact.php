...
<head>
    ...
    <title>หน้าติดต่อ | เอชทีเอ็มแอลไลบรารี่</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Contact.php" style="
                                                    color : #1BB2B6;"><i class="fa-solid fa-envelope" ></i> ติดต่อเรา</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <video loop muted autoplay style="
        ...
        z-index: -99;
        position: fixed">
            <source src="Video/Contact-header-videobg.mp4">
    </video>
    <main class="container-fluid p-5">
            <div class="container pt-5">
                <p class="text-white display-1 p-1 text-center" style="
                                                                font-family: kanit;
                                                                font-weight: bold;
                                                                user-select: none;"><i class="fa-solid fa-envelope"></i> ติดต่อ<span  style="
                                                                                                                                    color : #00b4d8;">เรา</span></p>
                <p class="text-center pb-1 text-white" style="
                                                    font-family: sarabun;
                                                    font-weight: bold;">ข้อความคุณจะส่งไปอีเมล <a class="link-info" href="mailto: htmllibraryth@gmail.com" target="_blank">htmllibraryth@gmail.com</a></p>
                <form class="container-sm p-5 border border-rounded" style="
                                        background-color:#ffffff2b;" action="https://formsubmit.co/htmllibraryth@gmail.com" class="form-contact" target="_blank" method="POST">
                    <div class="mb-3" style="
                                        font-family: sarabun;
                                        user-select: none;">
                                                        <label class="form-label text-white" for="name">ชื่อ-นามสกุล <span style="
                                                                                                                        color: red;">*</span></label>
                                                        <input class="form-control" id="name" name="name" type="text" placeholder="ใส่ชื่อนามสกุล..." oninvalid="this.setCustomValidity('ใส่ชื่อ-นามสกุล')" oninput="setCustomValidity('')" required="">
                    </div>
                    <div class="mb-3" style="
                                        font-family: sarabun;
                                        user-select: none;">
                                                        <label class="form-label text-white" for="subject">เรื่อง </label>
                                                        <select class="form-select" aria-label="Default select example" id="subject" name="subject">
                                                            <option selected>ไม่มีหัวข้อ</option>
                                                            <option value="contact1">1. ปัญหาเกี่ยวกับการใช้งานเว็บไซต์</option>
                                                            <option value="contact2">2. ติดต่อสอบถาม</option>
                                                            <option value="contact3">3. อื่นๆ</option>
                                                        </select>
                    </div>
                    <div class="mb-3" style="
                                        font-family: srabun;
                                        user-select: none;">
                                                        <label class="form-label text-white" for="email">อีเมล <span style="
                                                                                                                        color: red;">*</span></label>
                                                        <input class="form-control" id="email" name="email" type="email" placeholder="ใส่อีเมล..." oninvalid="this.setCustomValidity('ใส่อีเมล')" oninput="setCustomValidity('')" required="">
                    </div>
                    <div class="mb-3" style="
                                        font-family: srabun;
                                        user-select: none;">
                                                        <label class="form-label text-white" for="phone">เบอร์โทร</label>
                                                        <input class="form-control" id="phone" name="phone" type="text" placeholder="ใส่เบอร์โทร...">
                    </div>
                    <div class="mb-3" style="
                                        font-family: sarabun;
                                        user-select: none;">
                                                        <label class="form-label text-white" for="message">ข้อความ <span style="
                                                                                                                        color: red;">*</span></label>
                                                        <textarea class="form-control" id="message" name="message" type="text" placeholder="ใส่ข้อความ..." style="height: 10rem;" oninvalid="this.setCustomValidity('ใส่ข้อความ')" oninput="setCustomValidity('')" required=""></textarea>
                    </div>
                    <div class="d-grid" style="
                                        font-family: sarabun;
                                        user-select: none;">
                                                        <div class="d-flex justify-content-end">
                                                            <button class="btn btn-outline-info btn-lg" id="submitButton" onClick="window.location.reload(true)" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" type="submit">ส่งข้อความ</button>
                                                        </div>
                    </div>
    </main> 
